...
const ProjectCard = ({ slug, title, difficulty, duration }) => {
  return (
    <Link to={`/projects/${slug}`}>
      <div className="w-60 2xl:w-72 h-32 2xl:h-44 flex flex-col justify-center bg-neutral-700 font-inconsolata text-secondary border border-white rounded-md hover:bg-black hover:bg-opacity-20 hover:backdrop-blur-3xl">
